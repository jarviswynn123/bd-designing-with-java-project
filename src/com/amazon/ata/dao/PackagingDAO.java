    ...
    public PackagingDAO(PackagingDatastore datastore) {
        for (FcPackagingOption fcPackagingOption : datastore.getFcPackagingOptions()) {
            if (!fcPackagingOptionsMap.containsKey(fcPackagingOption.getFulfillmentCenter())) {
                ...
                set.add(fcPackagingOption);
                fcPackagingOptionsMap.put(fcPackagingOption.getFulfillmentCenter(), set);
            } else {
                Set<FcPackagingOption> set = fcPackagingOptionsMap.get(fcPackagingOption.getFulfillmentCenter());
                set.add(fcPackagingOption);
            }
        }
    }
